...
const Clock = () => {
    ...
    const countDown = () => {
        ...
        const destination = new Date('Oct 24, 2022').getTime();
        ...
        interval = setInterval(() => {
            ...
            const minutes = Math.floor(diffrent % (1000 * 60 * 60 * 24) / (1000 * 60));
    ...
    return <div className="clock__wrapper d-flex align-item-center gap-3">
